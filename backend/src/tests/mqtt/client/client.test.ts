...
const matchingTopicsWithoutWildcards: [string, string][] = [
  [`${BasicTerm.TABLE}/test/${BasicTerm.TEAM}/${TeamColor.WHITE}/${BasicTerm.BUTTON}/0`, `${BasicTerm.TABLE}/test/${BasicTerm.TEAM}/${TeamColor.WHITE}/${BasicTerm.BUTTON}/0`],
  [`${BasicTerm.TABLE}/test/${BasicTerm.TEAM}`, `${BasicTerm.TABLE}/test/${BasicTerm.TEAM}`],
  [`${BasicTerm.TABLE}/register`, `${BasicTerm.TABLE}/register`]
];

const nonMatchingTopicsWithoutWildcards: [string, string][] = [
  [`${BasicTerm.TABLE}/test/${BasicTerm.TEAM}/${TeamColor.WHITE}/${BasicTerm.BUTTON}/0`, `${BasicTerm.TABLE}/test/${BasicTerm.TEAM}/${BasicTerm.BUTTON}/0`],
  [`${BasicTerm.TABLE}/test/${BasicTerm.TEAM}`, `${BasicTerm.TABLE}/${BasicTerm.TEAM}`],
  [`${BasicTerm.TABLE}/register`, `${BasicTerm.TABLE}/`]
];


const matchingTopicsWithPlusWildcards: [string, string][] = [
  [`${BasicTerm.TABLE}/+/${BasicTerm.TEAM}/${TeamColor.WHITE}/${BasicTerm.BUTTON}/0`, `${BasicTerm.TABLE}/test/${BasicTerm.TEAM}/${TeamColor.WHITE}/${BasicTerm.BUTTON}/0`],
  [`${BasicTerm.TABLE}/test/${BasicTerm.TEAM}/${TeamColor.WHITE}/${BasicTerm.BUTTON}/+`, `${BasicTerm.TABLE}/test/${BasicTerm.TEAM}/${TeamColor.WHITE}/${BasicTerm.BUTTON}/0`],
  [`${BasicTerm.TABLE}/+/${BasicTerm.TEAM}/${TeamColor.WHITE}/${BasicTerm.BUTTON}/+`, `${BasicTerm.TABLE}/test/${BasicTerm.TEAM}/${TeamColor.WHITE}/${BasicTerm.BUTTON}/0`],
]

const matchingTopicsWithHashtagWildcards: [string, string][] = [
  [`${BasicTerm.TABLE}/#/${BasicTerm.TEAM}/${TeamColor.WHITE}/${BasicTerm.BUTTON}/0`, `${BasicTerm.TABLE}/test/${BasicTerm.TEAM}/${TeamColor.WHITE}/${BasicTerm.BUTTON}/0`],
  [`${BasicTerm.TABLE}/test/${BasicTerm.TEAM}/${TeamColor.WHITE}/${BasicTerm.BUTTON}/#`, `${BasicTerm.TABLE}/test/${BasicTerm.TEAM}/${TeamColor.WHITE}/${BasicTerm.BUTTON}/0`],
  [`${BasicTerm.TABLE}/#`, `${BasicTerm.TABLE}/test/${BasicTerm.TEAM}/${TeamColor.WHITE}/${BasicTerm.BUTTON}/0`],
]
