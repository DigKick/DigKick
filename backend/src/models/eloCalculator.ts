...
export class EloCalculator {
  ...
  public static getEloDifference(teamOne: Team, teamTwo: Team) {
    ...
    if (teamOne.isWinner && teamTwo.isWinner || (!teamOne.isWinner && !teamTwo.isWinner)) {
      this._logger.error("Exactly one team needs to be the winner to calculate a new elo score.")
      return 0
    }
