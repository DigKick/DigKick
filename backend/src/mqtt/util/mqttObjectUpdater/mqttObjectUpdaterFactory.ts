...
export class MqttObjectUpdaterFactory {
  ...
  private static mqttObjectUpdaters: Map<any, MqttObjectUpdater<any>> = new Map<any, MqttObjectUpdater<any>>()

  public static getMqttObjectUpdater(obj: any, config?: MqttObjectUpdaterConfig): MqttObjectUpdater<any> {
